...
class DefaultBookmarkFfi : BookmarkFfi {
    ...
    override fun getFolderChildren(folderId: String, sortBy: SortOrder) =
    ...
    override fun getBookmark(bookmarkId: String) =
        uniffi.mybriefcase_bookmarks_ffi.getBookmark(bookmarkId)

    override fun addBookmark(folderId: String, url: String, title: String) =
    ...
    override fun createFolder(parentFolderId: String, title: String) =
    ...
    override fun searchBookmarks(query: String, sortBy: SortOrder) =
        uniffi.mybriefcase_bookmarks_ffi.searchBookmarks(query, sortBy)

    override fun importHtml(folderId: String, html: String) =
...
class BookmarkRepositoryImpl(
    ...
    override suspend fun getFolderChildren(folderId: String, sortBy: SortOrder): FolderChildrenDto =
        withContext(ioDispatcher) { ffi.getFolderChildren(folderId, sortBy) }

    override suspend fun getFolderNavTree(): FolderNavTreeDto =
        withContext(ioDispatcher) { ffi.getFolderNavTree() }

    override suspend fun getBookmark(bookmarkId: String): BookmarkDto? =
        withContext(ioDispatcher) { ffi.getBookmark(bookmarkId) }

    override suspend fun addBookmark(folderId: String, url: String, title: String): String =
        withContext(ioDispatcher) { ffi.addBookmark(folderId, url, title) }
    ...
    override suspend fun createFolder(parentFolderId: String, title: String): String =
        withContext(ioDispatcher) { ffi.createFolder(parentFolderId, title) }
    ...
    override suspend fun deleteFolder(folderId: String) =
        withContext(ioDispatcher) { ffi.deleteFolder(folderId) }
    ...
    override suspend fun searchBookmarks(query: String, sortBy: SortOrder): List<BookmarkDto> =
        withContext(ioDispatcher) { ffi.searchBookmarks(query, sortBy) }

    override suspend fun importHtml(folderId: String, html: String): ImportResultDto =
        withContext(ioDispatcher) { ffi.importHtml(folderId, html) }

    override suspend fun exportHtml(): String =
        withContext(ioDispatcher) { ffi.exportHtml() }

    override suspend fun triggerFullMerge(): Boolean =
        withContext(ioDispatcher) { ffi.triggerFullMerge() }
}
